...
set LIB=D:\vs\vc\Tools\MSVC\14.39.33519\lib\x64;%LIB%
set LIBPATH=D:\vs\vc\Tools\MSVC\14.39.33519\lib\x64;%LIBPATH%
set INCLUDE=D:\VS\VC\Tools\MSVC\14.39.33519\include;%INCLUDE%
rmdir /q /s intel
mkdir intel
cd intel
