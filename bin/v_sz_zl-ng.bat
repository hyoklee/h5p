...
mkdir v26
cd v26
cmake -G "Visual Studio 18 2026"  -DCMAKE_TOOLCHAIN_FILE=C:/src/vcpkg.microsoft/scripts/buildsystems/vcpkg.cmake -DBUILD_SHARED_LIBS:BOOL=OFF  -DHDF5_ENABLE_ZLIB_SUPPORT:BOOL=ON -DHDF5_USE_ZLIB_NG:BOOL=ON -DHDF5_ENABLE_SZIP_SUPPORT:BOOL=ON  -DCTEST_DROP_SITE_INIT:STRING="my.cdash.org"  -DSITE="win-11" -DBUILDNAME="hk/vs-26.c/-sh/zl-ng" ..
